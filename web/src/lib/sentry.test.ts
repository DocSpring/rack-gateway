...
const browserTracingIntegrationMock = sentry.browserTracingIntegration as unknown as ReturnType<
  typeof vi.fn
>
...
function setEnv(key: string, value: string | undefined) {
  ...
  let meta = document.querySelector(`meta[name="${key}"]`) as HTMLMetaElement | null
