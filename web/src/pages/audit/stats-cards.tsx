...
export function AuditStatsCards({
  ...
  return (
    <div className="mb-6 grid gap-6 md:grid-cols-4">
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="font-medium text-muted-foreground text-sm">Success Rate</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="font-medium text-muted-foreground text-sm">Failed/Denied</CardTitle>
        </CardHeader>
        <CardContent>
