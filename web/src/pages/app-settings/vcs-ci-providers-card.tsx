					...
					<div className="space-y-4">
						...
						<div>
							...
							<div className="flex items-center gap-2">
								...
								>
									<option value="">Not set</option>
									<option value="circleci" disabled={!circleciAvailable}>
										CircleCI
									</option>
									<option value="github" disabled={!githubAvailable}>
										GitHub Actions
									</option>
								</select>
				...
				<div className="flex justify-end gap-2">
					...
					{hasChanges && (
						<>
							...
							<Button disabled={disabled || updateMutation.isPending} onClick={handleSave} size="sm">
								Save
							</Button>
						</>
					)}
