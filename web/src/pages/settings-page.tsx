    ...
    <div className="p-8">
      ...
      <div className="grid gap-6 md:grid-cols-2">
          ...
          <CardContent>
            ...
            <div className="flex gap-2">
              <div className="flex-1">
                <Label className="mt-2 mb-2" htmlFor="new-var">
                  Add Key
                </Label>
                <Input
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-3 text-muted-foreground text-sm">
              Commands that can be executed during an active deployment approval window. Uses exact
              string matching.
            </p>
            <div className="flex gap-2">
              <div className="flex-1">
                <Label className="mt-2 mb-2" htmlFor="new-command">
                  Add Command
                </Label>
                <Input
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-3 text-muted-foreground text-sm">
              Define image tag validation patterns for deploy approval manifest validation. Use{' '}
            ...
            <div className="flex gap-2">
              <div className="flex-1">
                <Label className="mt-2 mb-2" htmlFor="new-app-name">
                  App Name
                </Label>
                <Input
                  disabled={!isAdmin || isLoading || saveAppPatternsMutation.isPending}
                  id="new-app-name"
              ...
              <div className="flex-1">
                <Label className="mt-2 mb-2" htmlFor="new-pattern">
                ...
                Object.entries(appImageTagPatterns).map(([app, pattern]) => (
                  ...
                  >
                    <div className="flex-1 space-y-1">
                      ...
                      <div className="font-mono text-muted-foreground text-xs">{pattern}</div>
                    </div>
                    <button
