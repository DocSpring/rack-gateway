...
export interface paths {
    ...
    "/apps/{app}/settings": {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            [key: string]: components["schemas"]["settings.Setting"];
                        };
                    };
                };
                /** @description Internal Server Error */
        ...
        put: {
            ...
            requestBody: components["requestBodies"]["Settings"];
            responses: {
                /** @description OK */
                200: {
                    headers: {
    ...
    "/apps/{app}/settings/approved-deploy-commands": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        /**
         * Update approved deploy commands
        ...
        put: {
            ...
            /** @description Approved command list */
            requestBody: {
                content: {
        ...
        post?: never;
        /**
         * Delete approved deploy commands
    ...
    "/apps/{app}/settings/protected-env-vars": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put: {
            ...
            /** @description Protected environment variable names */
            requestBody: {
                content: {
                    "application/json": string[];
                };
        ...
        post?: never;
        /**
         * Delete protected environment variables
    ...
    "/apps/{app}/settings/secret-env-vars": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put: {
            ...
            /** @description Secret environment variable names */
            requestBody: {
                content: {
                    "application/json": string[];
                };
        ...
        post?: never;
        /**
         * Delete secret environment variables
    ...
    "/apps/{app}/settings/service-image-patterns": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put: {
            ...
            /** @description Service image patterns */
            requestBody: {
                content: {
                    "application/json": {
                        [key: string]: string;
    ...
    "/auth/mfa/trusted-devices/trust": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/deploy-approval-requests/{id}/approve": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/settings": {
        ...
        post?: never;
        /**
         * Delete multiple global settings
    ...
    "/settings/rack_tls_cert/refresh": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["settings.Setting"];
                    };
                };
                /** @description Not Found */
                404: {
    ...
    "/users/{email}/sessions/revoke_all": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/users/{email}/sessions/{sessionID}/revoke": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
