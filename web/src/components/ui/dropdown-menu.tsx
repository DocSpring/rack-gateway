// biome-ignore lint/performance/noNamespaceImport: Radix UI requires namespace import for proper component composition
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      className={cn(
        'flex select-none items-center rounded-sm px-2 py-1.5 text-sm outline-hidden focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[inset]:pl-8 data-[state=open]:text-accent-foreground',
        className,
      )}
      data-inset={inset}
