...
const WEB_PORT = env.E2E_GATEWAY_PORT || env.TEST_GATEWAY_PORT || env.WEB_PORT || '5223'
const EFFECTIVE_PORT =
  env.E2E_GATEWAY_PORT || env.TEST_GATEWAY_PORT || env.GATEWAY_PORT || env.WEB_PORT || '5223'
const GATEWAY_PORT = env.E2E_GATEWAY_PORT || env.TEST_GATEWAY_PORT || env.GATEWAY_PORT || '8447'
...
console.log(
  ...
  VITE_API_BASE_URL || `(in-container) http://gateway-api:${GATEWAY_PORT}`
)
