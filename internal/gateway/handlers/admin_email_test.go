...
import (
	...
	emailpkg "github.com/DocSpring/convox-gateway/internal/gateway/email"
...
func newAdminHandler(t *testing.T, sender emailpkg.Sender) (*handlers.AdminHandler, *db.Database, rbac.RBACManager) {
	...
	handler := handlers.NewAdminHandler(rbacManager, database, tokenService, sender, cfg, nil, nil)
