...
func connectAppDatabase(t *testing.T, dsn string) *db.Database {
	...
	os.Setenv("TEST_DATABASE_URL", dsn) //nolint:errcheck,gosec // G104: ignore error
	return app
}
...
func registerCleanup(t *testing.T, app *db.Database, admin *sql.DB, adminCleanup func(), dbName string) {
	...
	t.Cleanup(func() {
		...
		//nolint:gosec // G201: dbName is generated by code and properly quoted with pqQuoteLiteral
