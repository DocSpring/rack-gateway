...
echo "   - http://localhost:8447/.gateway/api/auth/cli/callback (for development)"
echo "   - https://your-gateway-domain.com/.gateway/api/auth/cli/callback (for production)"
echo "5. Click 'CREATE'"
echo ""
...
echo "2. Run 'task dev' to start the development environment"
echo "3. Test login at http://localhost:8447/.gateway/api/auth/cli/start"
echo ""
