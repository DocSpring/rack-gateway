...
echo "    # interactive (opens browser)"
echo "    convox-gateway login local http://localhost:${GW_PORT}"
echo "    # non-interactive (mock OAuth dev only)"
echo "    convox-gateway login local http://localhost:${GW_PORT} --non-interactive --email admin@company.com"
