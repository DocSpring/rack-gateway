...
<Aside type="tip">
Run `rack-gateway-api migrate` as part of your deployment process to ensure the schema is up to date before starting the application.
</Aside>
