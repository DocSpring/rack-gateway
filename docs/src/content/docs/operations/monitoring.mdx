...
Use for:
- Container/pod readiness probes
- Deployment verification
- Dependency health validation

<Aside type="tip">
The readiness endpoint verifies database connectivity. If it fails, the gateway can receive requests but may not function correctly.
</Aside>
...
Rack Gateway uses structured JSON logging:
