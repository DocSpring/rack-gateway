...
| Permission | Description | Roles |
|------------|-------------|-------|
| `convox:build:list` | List builds | viewer, ops, deployer, cicd, admin |
| `convox:build:read` | View build details | viewer, ops, deployer, cicd, admin |
| `convox:build:create` | Create new build | deployer, admin |
| `convox:build:delete` | Delete build | admin |
...
| `gateway:api_token:create` | Create new token | deployer, admin |
...
| Permission | Description | Roles |
|------------|-------------|-------|
| `gateway:setting:read` | View gateway settings | admin |
| `gateway:setting:set` | Modify gateway settings | admin |
| `gateway:setting:{key}` | Modify specific setting | admin |

Settings are controlled individually by key. See [Settings](/user-guide/web-ui/settings/) for available keys.
...
|------------|-------------|-------|
| `auth:mfa_method:list` | List user's MFA methods | Self-service |
...
|----------|--------|------------|
| `/apps` | GET | `convox:app:list` |
| `/apps/:name` | GET | `convox:app:read` |
| `/apps/:name` | DELETE | `convox:app:delete` |
| `/apps/:name/builds` | POST | `convox:build:create` |
| `/apps/:name/processes` | GET | `convox:process:list` |
| `/apps/:name/processes/:id/exec` | POST | `convox:process:exec` |
| `/apps/:name/env` | GET | `convox:env:read` |
| `/apps/:name/env` | POST | `convox:env:set` |
| `/apps/:name/releases/:id/promote` | POST | `convox:release:promote` |
